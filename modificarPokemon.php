...
<head>
    ...
    <?php 
        ...
        echo "<script>console.log('$numPokedex, $nombre, $peso, $altura, $ps, $ataque, $defensa, $especial, $velocidad')</script>";
        $sql = "CALL modificarPokemon($numPokedex, '$nombre', $peso, $altura, $ps, $ataque, $defensa, $especial, $velocidad);";
    ?>
